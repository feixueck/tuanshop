...
<div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <div class="tab-content default-tab" id="tab1">
         ...
         <form action="${staticServer}/authority/add" method="post"> 
         	<table>
				<tr> <td ><input name="name" id="status"  type="text" placeholder="输入权限名"/></td> </tr>
				<tr> <td><input name="description" id="status"  type="text"placeholder="输入备注"/></td> </tr>
				<tr>
					<td>
						<input  class="btn5" type="button" onclick="window.open('${staticServer}/authority/index')" value="返回列表" />
